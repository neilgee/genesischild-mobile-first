...
- Genesis Responsive Menu version 1.1.2 is added but not enabled, to enable it uncomment in *functions.php* line 56 *	// include_once( get_stylesheet_directory() . '/includes/responsive-menu.php' );*
